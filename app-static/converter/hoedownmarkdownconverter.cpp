...
MarkdownDocument *HoedownMarkdownConverter::doCreateDocument(const QString &text, ConverterOptions options)
{
...
QString HoedownMarkdownConverter::doRenderAsHtml(MarkdownDocument *document)
{
    QString html;
